...
| 0:38–1:08 | Open **Markets**; select PocketLedger; search for India and add a Hindi locale alongside the existing English plan; inspect Play, Galaxy, web, and GitHub surfaces | “Each app keeps a separate plan for each language and market. This locale catalogue is sourced from Unicode CLDR. The checklist still asks a person to verify store availability, local rules, translation, and assets.” |
| 1:08–1:23 | Edit the app summary, generate English starter copy, adjust one locale field, check a completed task, export the JSON brief | “The English draft uses this app’s summary. Search phrases are suggestions, not keyword research, and this still needs native translation and human review. The export carries the fields and remaining work; it does not publish.” |
