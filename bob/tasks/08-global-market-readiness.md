...
The workspace supports independent product records and local country/locale plans drawn from 257 Unicode CLDR country/territory profiles and 585 locale suggestions. It lists Google Play, Apple App Store, Samsung Galaxy Store, web SEO, and GitHub Releases, and exports per-app JSON planning briefs. It must remain honest: this is not a live store integration, proof of store availability, translation engine, keyword-ranking tool, legal determination, or exhaustive global compliance scanner.
...
3. Add focused tests for CLDR catalog validity, market-search behavior, data separation, field sanitization, and export contents if the existing test structure supports them.
